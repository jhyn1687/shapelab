  ...
  content: [
    {
      type: "text",
      value:
    "The vast majority of experiments in the lab are focused on understanding \
    how neurons in midlevel stages encode visual stimuli and how these \
    representations are built from local orientation and spatial frequency \
    tuning in earlier stages. We use systematic, parametrically designed \
    stimuli - shapes, textures and combinations - to probe the responses of neurons. \
    We also use descriptive and image-computable models to understand what is encoded \
    by individual neurons. We are also leveraging deep CNN models to understand how \
    representations in the primate brain differ from those in artificial networks \
    and gain insights about how representations are built. "},
    {
      type: "text",
      value:"Some relevant publications:"
    },
    {
      type: "publication",
      value: {
